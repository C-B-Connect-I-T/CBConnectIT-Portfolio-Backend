...
object ServiceInstrumentation {
    ...
    fun givenAValidInsertNewServiceWithParent() = InsertNewService("Sub service", imageUrl = "https://www.google.be/image", description = "Sub description", tagId = "00000000-0000-0000-0000-000000000001", parentServiceId = "00000000-0000-0000-0000-000000000001")
    ...
    fun givenAValidUpdateServiceWithParent() = UpdateService("Sub service", imageUrl = "https://www.google.be/image", description = "sub description", tagId = "00000000-0000-0000-0000-000000000001", parentServiceId = "00000000-0000-0000-0000-000000000001")
    ...
    fun givenAService(id: UUID = UUID.randomUUID(), name: String = "Parent Service", subService: Service) = Service(id = id, title = name, description = "Parent description", subServices = listOf(subService))
}